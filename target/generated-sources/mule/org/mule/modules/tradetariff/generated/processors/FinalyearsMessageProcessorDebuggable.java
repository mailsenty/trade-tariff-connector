...
public class FinalyearsMessageProcessorDebuggable
    extends FinalyearsMessageProcessor
    implements DebugInfoProvider
{


    public FinalyearsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("finalyears", "Finalyears", (java.lang.String.class), finalyears, muleEvent));
