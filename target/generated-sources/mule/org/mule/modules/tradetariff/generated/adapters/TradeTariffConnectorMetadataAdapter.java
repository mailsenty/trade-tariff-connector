...
/**
 * A <code>TradeTariffConnectorMetadataAdapter</code> is a wrapper around {@link TradeTariffConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-23T02:51:09-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class TradeTariffConnectorMetadataAdapter
    extends TradeTariffConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "TradeTariff";
