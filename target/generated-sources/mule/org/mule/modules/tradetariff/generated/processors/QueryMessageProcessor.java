...
/**
 * QueryMessageProcessor invokes the {@link org.mule.modules.tradetariff.TradeTariffConnector#query(java.lang.String)} method in {@link TradeTariffConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((TradeTariffConnector) object).query(_transformedQuery);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at TradeTariffConnector at query retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
