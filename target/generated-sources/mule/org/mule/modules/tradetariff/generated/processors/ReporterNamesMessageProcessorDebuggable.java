...
public class ReporterNamesMessageProcessorDebuggable
    extends ReporterNamesMessageProcessor
    implements DebugInfoProvider
{


    public ReporterNamesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("reporterNames", "Reporter names", (java.lang.String.class), reporterNames, muleEvent));
